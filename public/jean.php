...
<table cellspacing="5">
  <tr>
    <td><div id="hood"><img src="bblue-jeans.png" alt="Image"></div></td>
  </tr>
  <tr>
    <div id="itemname" value="Jeans" hidden >Jeans</div>
  </tr>
  <tr>
    <td><div id="price">39.99$</div></td>
  ...
  <select name="color" id="color-select" onchange="changeColor()">
    <option value="bblue">Baby Blue</option>
    <option value="nblue">Navy Blue</option>
  </select>
  <br>
