...
<table cellspacing="5">
	<tr>
		<td><div id="hood" style="position: relative;"><img src="red-basketball.png" alt="Image"></div>
         <div id="discount-badge" class="discount-badge" style="position: absolute; top: 100px; right: 500px; background-color: #ef233c; color: white; padding: 5px; font-size: 20px;  z-index: 100;  display: block;">
          -20%
  ...
  <tr>
    <div id="itemname" value="Basketball" hidden >Basketball</div>
  </tr>
	<tr>
		<td><span style="text-decoration: line-through;">24.99$</span><br><div id="price">19.99$</div></td>
